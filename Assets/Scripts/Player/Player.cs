...
namespace PLAYERTWO.PlatformerProject
{
	...
	public class Player : Entity<Player>
	{
		...
		[SerializeField] GameObject pickableObjectEffect;
            ...
            if (stats.current.canPickUp)
			{
				if (!holding)
				{
						...
						stats.current.pickDistance, out var hit))
					{
						...
						{
                            if (pickableObjectEffect != null) pickableObjectEffect.transform.position = hit.transform.position;
                            if (pickableObjectEffect != null) pickableObjectEffect.transform.parent = hit.transform;
                            if (pickableObjectEffect != null)  pickableObjectEffect.SetActive(true);
						}
                       
					}
					else
					{
                       if(pickableObjectEffect != null) pickableObjectEffect.SetActive(false);
                    }
				}
            }
			else
			{
                pickableObjectEffect.SetActive(false);
            }
